...
namespace Bricker.Rendering
{
    ...
    public static class Colors
    {
        ...
        private static readonly SKColor _debugBlack;
        private static readonly SKColor _white;
        private static readonly SKColor _textWhite;
        ...
        public static SKColor DebugBlack => _debugBlack;
        public static SKColor White => _white;
        public static SKColor TextWhite => _textWhite;
        ...
        static Colors()
        {
            ...
            _debugBlack = new SKColor(25, 0, 0);
            _white = new SKColor(240, 230, 220);
            _textWhite = new SKColor(196, 187, 175);
